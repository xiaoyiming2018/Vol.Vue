...
import ssoHttp from './api/ssoHttp'
import apmHttp from './api/apmHttp'
...
Vue.prototype.ssoHttp.init(vue);

Vue.prototype.apmHttp = apmHttp;
Vue.prototype.apmHttp.init(vue);
