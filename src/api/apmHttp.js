...
//axios.defaults.baseURL用于设置axios的默认请求地址
axios.defaults.baseURL = '/api-apm';
...
axios.interceptors.response.use((res) => {
  ...
  // }
  //显示sso认证返回的错误
  httpMessage = error.data.message
...
function ajax(param) {
  ...
  httpParam.url = "https://portal-apm-apm-eks005.hz.wise-paas.com.cn/api-apm" + httpParam.url.replace(/\/?/, '');
